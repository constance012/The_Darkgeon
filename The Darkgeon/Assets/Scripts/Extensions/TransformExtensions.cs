...
public static class TransformExtensions
{
	...
	/// <summary>
	/// Gets an array of components in a specified child of this Transform, includes inactive one.
	/// </summary>
	/// <typeparam name="TComponent"></typeparam>
	/// <param name="transform"></param>
	...
	/// <returns></returns>
	public static TComponent GetComponentInSibling<TComponent>(this Transform transform, string siblingName)
	{
		Transform sibling = transform.parent.Find(siblingName);
